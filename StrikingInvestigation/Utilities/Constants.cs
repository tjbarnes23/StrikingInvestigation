...
namespace StrikingInvestigation.Utilities
{
    ...
    {
        public const double DiameterScale = 1.5;
        ...
        public const string DisabledUnstruckTestBellColor = "#007BFF";
        public const string StruckBellColor = "#A00000";

        public const int DisplayDelay = 9;
